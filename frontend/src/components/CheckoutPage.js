                ...
                <div className="space-y-3 mb-6">
                  {cart.map(item => (
                    <div key={`${item.id}-${item.size}`} className="flex gap-4 items-center py-3 border-b border-gray-50">
                      <img
                        src={item.primary_image||item.images?.[0]?.image_url||item.images?.[0]||'https://via.placeholder.com/56x64'}
                        alt={item.name}
              ...
              {cart.map(item => (
                <div key={`${item.id}-${item.size}`} className="flex gap-3 items-center">
                  <div className="relative flex-shrink-0">
                    <img
                      src={item.primary_image||item.images?.[0]?.image_url||item.images?.[0]||'https://via.placeholder.com/48x56'}
                      alt={item.name}
